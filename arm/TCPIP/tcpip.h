...
typedef struct 
{
  ...
  U8_T  subnet_port;  //?υτ?????????? 1- MainPort      2-ZigbeePort      3-SubPort
  U8_T  subnet_baudrate;   // ???υτ????baud
}STR_SCAN_CMD;
...
extern STR_SEND_BUF bip_bac_buf_COV;
extern STR_SEND_BUF bip_bac_buf_BBMD;
extern STR_SEND_BUF mstp_bac_buf[50];
...
extern uip_ipaddr_t broadcast_addr;
// UDP CLIENT SCAN 

#define UDP_SCAN_LPORT 1234
//#define UDP_SCAN_SEND_LPORT 1235

extern U16_T udp_scan_lport;
extern char uip_test[100];
extern U8_T flag_uip_test;
